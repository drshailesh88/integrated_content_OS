...
export function SugarSlide8() {
  ...
  const keyPoints = [
    { icon: '🔄', text: 'Work with your biology' },
    { icon: '✅', text: 'Not about perfection' }
  ];
          ...
          <div className="w-full px-6">
            ...
            <div className="grid grid-cols-2 gap-4 max-w-[800px] mx-auto mb-5">
              {keyPoints.map((point, index) => (
                <div key={index} className="rounded-2xl p-5 text-center" style={{ backgroundColor: 'rgba(32, 113, 120, 0.15)' }}>
                  <p style={{ 
                    fontFamily: 'Inter, sans-serif',
                    fontSize: '48px',
                    fontWeight: 700,
            ...
            <div className="max-w-[900px] mx-auto rounded-2xl p-6 mb-5" style={{ backgroundColor: 'rgba(230, 57, 70, 0.15)', border: '3px solid #E63946' }}>
              <p style={{ 
                ...
                When You Make These Swaps:
              </p>
              <div className="space-y-2">
                {results.map((result, index) => (
                  <div key={index} className="p-3 rounded-lg" style={{ backgroundColor: 'rgba(255, 255, 255, 0.7)' }}>
                    <p style={{ 
                      fontFamily: 'Inter, sans-serif',
                      fontSize: '26px',
                      fontWeight: 600,
            ...
            <div className="max-w-[900px] mx-auto rounded-2xl p-5 mb-4" style={{ backgroundColor: 'rgba(32, 113, 120, 0.15)', border: '2px solid #207178' }}>
              <p style={{ 
                ...
                The goal is not perfection. It is understanding what these foods do inside you.
              </p>
            </div>
            ...
            <div className="max-w-[900px] mx-auto rounded-3xl p-6 shadow-2xl" style={{ background: 'linear-gradient(to right, #207178, #F28C81)' }}>
              <div className="text-center">
                <p style={{ 
                  ...
                  Make choices that work with your biology, not against it.
                </p>
              </div>
            </div>
          </div>
