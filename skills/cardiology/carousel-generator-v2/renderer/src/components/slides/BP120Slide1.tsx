    ...
    <SlideLayout slideNumber="01/08" backgroundElements={backgroundElements}>
      <div className="text-center px-6">
        ...
        <h1 style={{ 
          ...
          Your doctor just told you your blood pressure is 120/80.
        </h1>
        ...
        <div className="inline-block px-7 py-5 rounded-2xl mb-6" style={{ backgroundColor: 'rgba(32, 113, 120, 0.1)' }}>
          <p style={{ 
            ...
            You've heard that number your whole life. It's supposed to be normal, right?
          </p>
        </div>
        ...
        <p style={{ 
          ...
          Here's what nobody tells you about 120/80...
        </p>
      </div>
    </SlideLayout>
  );
