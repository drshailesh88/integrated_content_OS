...
import { Candy, AlertTriangle } from 'lucide-react';

export function SugarSlide1() {
    ...
    <SlideLayout slideNumber="01/08" backgroundElements={backgroundElements}>
      <div className="text-center px-6">
        ...
        <div className="flex justify-center mb-5">
          <div className="relative">
            <div className="w-20 h-20 rounded-full bg-gradient-to-br from-[#E63946] to-[#F28C81] flex items-center justify-center shadow-lg">
              <Candy size={44} color="#F8F9FA" strokeWidth={3} />
            </div>
          </div>
        </div>
        ...
        <h1 style={{ 
          ...
          Why Sugar and Refined Grains Make You Gain Weight
        </h1>
        ...
        <div className="inline-block px-7 py-5 rounded-2xl mb-6" style={{ backgroundColor: 'rgba(32, 113, 120, 0.1)' }}>
          <p style={{ 
            ...
            (And It Is Not Just About Calories)
          </p>
        </div>
        ...
        <p style={{ 
          ...
          These foods trigger a specific chain reaction that actively promotes fat storage.
        </p>
      </div>
    </SlideLayout>
  );
