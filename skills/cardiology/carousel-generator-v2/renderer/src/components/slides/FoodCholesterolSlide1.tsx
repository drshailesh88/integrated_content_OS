...
export function FoodCholesterolSlide1() {
    ...
    <SlideLayout slideNumber="01/08" backgroundElements={backgroundElements}>
      <div className="text-center px-6">
        ...
        <h1 style={{ 
          ...
          Why Your Favorite Foods Are Quietly Destroying Your Cholesterol
        </h1>
        ...
        <div className="inline-block px-7 py-5 rounded-2xl mb-6" style={{ backgroundColor: 'rgba(32, 113, 120, 0.1)' }}>
          <p style={{ 
            ...
            Your cholesterol report came back abnormal. Nobody explained WHY.
          </p>
        </div>
        ...
        <p style={{ 
          ...
          Let me show you exactly which foods are doing the damage.
        </p>
      </div>
    </SlideLayout>
  );
