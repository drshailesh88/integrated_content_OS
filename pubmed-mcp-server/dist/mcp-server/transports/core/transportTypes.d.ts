 ...
 */
export type HttpStatusCode = 200 | 201 | 400 | 401 | 403 | 404 | 409 | 429 | 500 | 502 | 503;
/**
 ...
 */
export type TransportResponse = BufferedTransportResponse | StreamingTransportResponse;
/**
