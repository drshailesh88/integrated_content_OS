...
(function (BaseErrorCode) {
    ...
    BaseErrorCode["NCBI_API_ERROR"] = "NCBI_API_ERROR";
    /** An error occurred while parsing a response from NCBI (e.g., XML, JSON). */
    BaseErrorCode["NCBI_PARSING_ERROR"] = "NCBI_PARSING_ERROR";
    /** A warning or notice related to NCBI rate limits. */
    BaseErrorCode["NCBI_RATE_LIMIT_WARNING"] = "NCBI_RATE_LIMIT_WARNING";
    /** An error related to the construction or validity of an NCBI E-utility query. */
    BaseErrorCode["NCBI_QUERY_ERROR"] = "NCBI_QUERY_ERROR";
    /** NCBI service temporarily unavailable or returned a server-side error. */
    BaseErrorCode["NCBI_SERVICE_UNAVAILABLE"] = "NCBI_SERVICE_UNAVAILABLE";
